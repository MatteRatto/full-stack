      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="border-t border-gray-200 pt-6">
          ...
          <div className="mb-4">
            ...
            >
              Password Attuale
              {watchNewPassword && <span className="text-red-500 ml-1">*</span>}
            </label>
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">
              La password deve contenere almeno 6 caratteri con una maiuscola,
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            disabled={loading}
            className="bg-primary-600 text-white px-6 py-2 rounded-md text-sm font-medium hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            {loading ? (
